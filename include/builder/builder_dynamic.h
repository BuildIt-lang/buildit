...
static std::string get_temp_filename(builder_context &context) {
...
static void* compile_and_return_ptr(builder_context &context, std::string source_name, std::string fname) {
